...
const dispatch = useAppDispatch();
  ...
  useEffect(() => {
    //что это роутер парамс??

     userId = props.router.params.userId
    //не засовываем в диспатч, так как есть контейнерная компонента

    //мы делаем запрос на сервер именно здесь, 
    //потому что при монтировании компоненты нам надо увидеть не пустую, а уже заполненную компоненту
